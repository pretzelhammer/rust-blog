...
- [Заблуждения](#заблуждения)
    ...
    - [10) замыкания следуют тем же правилам неявного вывода времён жизни (lifetime elision), что и функции](#10-замыкания-следуют-тем-же-правилам-вывода-времён-жизни-что-и-функции)
